...
async function updateSubmit() {
  try {
    ...
    const url = `${window.location.origin}/admin/console/users`;
    const options = {
      method: 'PUT',
    ...
    const rawUpdateDataResponse = await fetch(url, options);
    const updateDataResponse = await rawUpdateDataResponse.json();
