...
async function updateSubmit() {
  try {
    ...
    const longitude_sec = [];
    const approach_time = [];
    const approach_gps_no = [];
    const leaving_time = [];
    const leaving_gps_no = [];
    const leaving_method = [];
    const sighting_method = [];
    const type_confirmation = [];
    const dolphin_group_no = [];
    const dolphin_type_no = [];
    const dorsal_fin = [];
    const exhalation = [];
    const splash = [];
    const exhibition = [];
    const mother_child = [];
    const mother_child_no = [];
    const group_size_lowest = [];
    const group_size_probable = [];
    const group_size_highest = [];
    const mix_type = [];
    const time1 = [];
    const boat_interaction1 = [];
    const boat_distance1 = [];
    const group_closeness_normal1 = [];
    const group_closeness_spreaded1 = [];
    const group_closeness_close1 = [];
    const speed_slow1 = [];
    const speed_moderate1 = [];
    const speed_fast1 = [];
    const speed_resting1 = [];
    const speed_circling1 = [];
    const foraging_maybe1 = [];
    const foraging_sure1 = [];
    const mating1 = [];
    const splash_interaction1 = [];
    const snorkel1 = [];
    const racing1 = [];
    const jump1 = [];
    const surfing_artificial1 = [];
    const surfing1 = [];
    const tail_lift1 = [];
    const contact1 = [];
    const backstroke1 = [];
    ...
    const other1 = [];
    const time2 = [];
    const boat_interaction2 = [];
    const boat_distance2 = [];
    const group_closeness_normal2 = [];
    const group_closeness_spreaded2 = [];
    const group_closeness_close2 = [];
    const speed_slow2 = [];
    const speed_moderate2 = [];
    const speed_fast2 = [];
    const speed_resting2 = [];
    const speed_circling2 = [];
    const foraging_maybe2 = [];
    const foraging_sure2 = [];
    const mating2 = [];
    const splash_interaction2 = [];
    const snorkel2 = [];
    const racing2 = [];
    const jump2 = [];
    const surfing_artificial2 = [];
    const surfing2 = [];
    const tail_lift2 = [];
    const contact2 = [];
    const backstroke2 = [];
    ...
    const other2 = [];
    const time3 = [];
    const boat_interaction3 = [];
    const boat_distance3 = [];
    const group_closeness_normal3 = [];
    const group_closeness_spreaded3 = [];
    const group_closeness_close3 = [];
    const speed_slow3 = [];
    const speed_moderate3 = [];
    const speed_fast3 = [];
    const speed_resting3 = [];
    const speed_circling3 = [];
    const foraging_maybe3 = [];
    const foraging_sure3 = [];
    const mating3 = [];
    const splash_interaction3 = [];
    const snorkel3 = [];
    const racing3 = [];
    const jump3 = [];
    const surfing_artificial3 = [];
    const surfing3 = [];
    const tail_lift3 = [];
    const contact3 = [];
    const backstroke3 = [];
    ...
    const url = `${window.location.origin}/admin/console/database`;
    const options = {
      method: 'PUT',
    ...
    const raUpdateDataResponse = await fetch(url, options);
    const updateDataResponse = await raUpdateDataResponse.json();
...
async function download() {
  try {
    const accessToken = localStorage.getItem('access_token');
    const url = `${window.location.origin}/api/1.0/data/download`;
    const options = {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
    ...
    const filenameArr = response.headers.get('Content-Disposition').split('=');
